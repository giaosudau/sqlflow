...
class Lexer:
    ...
    def _tokenize_next(self) -> None:
        ...
        if self.text[self.pos] == '{':
            ...
            if success:
                self.tokens.append(Token(TokenType.JSON_OBJECT, json_value, self.line, self.column))
        ...
        self.tokens.append(Token(TokenType.ERROR, self.text[self.pos], self.line, self.column))
        self.column += 1
        self.pos += 1

...
class TestUDFDependencyDetection:
    """Test cases for UDF dependency detection in the planner."""

    def test_extract_udf_table_dependencies(self):
    ...
    def test_table_udf_dependency_in_pipeline(self):

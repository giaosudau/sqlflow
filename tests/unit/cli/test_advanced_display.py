...
class TestAdvancedDisplay:
    ...
    @patch("typer.prompt")
    def test_display_interactive_pipeline_selection_success(
        self, mock_prompt, mock_list
    ):
    ...
    @patch("sqlflow.cli.advanced_display.list_pipelines_operation")
    @patch("typer.prompt")
    def test_display_interactive_pipeline_selection_invalid_input(
        self, mock_prompt, mock_list
    ):
...
class TestAdvancedIntegration:
    ...
    def test_run_pipeline_with_advanced_progress_fallback(
        self, mock_executor, mock_compile
    ):
        ...
        with patch(
            "sqlflow.cli.advanced_integration.run_pipeline_operation"
        ) as mock_run:
    ...
    @patch("sqlflow.cli.advanced_integration.compile_pipeline_operation")
    @patch("sqlflow.cli.advanced_integration.create_executor_for_command")
    def test_run_pipeline_with_advanced_progress_enabled(
        self, mock_executor, mock_compile
    ):

...
class TestAdvancedTableUDFFunctionality:
    ...
    def advanced_table_processor(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        final_result: pd.DataFrame = result[["id", "name", "computed_value", "category"]]
        return final_result
    ...
    def test_explicit_schema_registration(self):
        ...
        try:
            engine.register_python_udf("advanced_processor", self.advanced_table_processor)
    ...
    def test_schema_inference_registration(self):
        ...
        try:
            engine.register_python_udf("inference_processor", self.schema_inference_processor)
            ...
            assert hasattr(registered_func, "_infer_schema") or hasattr(registered_func, "_infer")
    ...
    def test_struct_type_generation_from_schema(self):
        ...
        from sqlflow.core.engines.duckdb.udf.registration import AdvancedTableUDFStrategy
    ...
    def test_registration_error_handling(self):
        ...
        try:
            ...
            print(f"✅ Error handling provides informative messages: {type(e).__name__}")
...
class TestBackwardCompatibility:
    ...
    def test_legacy_strategy_redirection(self):
        ...
        from sqlflow.core.engines.duckdb.udf.registration import VectorizedTableUDFStrategy

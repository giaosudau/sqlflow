...
class TestVariableSubstitutionPerformance:
    ...
    def test_large_variable_set_performance(self):
        ...
        assert performance_ratio < 4.0, f"New system doesn't scale well: {performance_ratio:.2f}x slower"
    ...
    def test_complex_template_performance(self):
        ...
        assert performance_ratio < 3.0, f"New system too slow for complex templates: {performance_ratio:.2f}x"
    ...
    def test_priority_resolution_performance(self):
        ...
        assert performance_ratio < 5.0, f"Priority resolution too slow: {performance_ratio:.2f}x"
    ...
    def test_initialization_performance(self):
        ...
        assert init_ratio < 5.0, f"New system initialization too slow: {init_ratio:.2f}x"

...
from sqlflow.core.executors.v2.handlers.base import observed_execution, StepHandler
...
class TestObservabilityDecorator:
    ...
    def test_observability_manager_failure_handling(self, mock_step, mock_context):
        ...
        mock_context.observability_manager.record_step_start.side_effect = Exception("Observability error")
